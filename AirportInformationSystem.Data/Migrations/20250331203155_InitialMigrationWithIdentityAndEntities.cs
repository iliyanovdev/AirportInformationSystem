...
{
    /// <inheritdoc />
    public partial class InitialMigrationWithIdentityAndEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FlightRoutes_AirplaneTypes_AirplaneTypeId",
                        column: x => x.AirplaneTypeId,
                        principalTable: "AirplaneTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlightRoutes_Cities_ArrivalCityId",
                        column: x => x.ArrivalCityId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FlightRoutes_Cities_DepartureCityId",
                        column: x => x.DepartureCityId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FlightRoutes_Companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FlightCode = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightRoutes_AirplaneTypeId",
                table: "FlightRoutes",
                column: "AirplaneTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_FlightRoutes_ArrivalCityId",
                table: "FlightRoutes",
                column: "ArrivalCityId");

            migrationBuilder.CreateIndex(
                name: "IX_FlightRoutes_CompanyId",
                table: "FlightRoutes",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_FlightRoutes_DepartureCityId",
                table: "FlightRoutes",
